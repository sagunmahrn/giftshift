                ...
                <div class="seq-screen">
                    ...
                    <ul class="seq-canvas">
                        ...
                        @foreach($sliderData as $slider)
                            <li>
                                <div class="seq-model">
                                    <img data-seq src="{{url('lib/uploads/images/sliders/'.$slider->image)}}"
                                         alt="Men slide img"/>
                                </div>
                                <div class="seq-title">
                                    {{--<span data-seq>Save Up to 75% Off</span>--}}
                                    {{--<h2 data-seq>{!! ucfirst($slider->title) !!}</h2>--}}
                                    {{--<p data-seq>Lorem ipsum illum.</p>--}}
                                    <a data-seq href="{{route('slider-details').'/'.$slider->slug}}"
                        ...
                        <div class="aa-product-area">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                @foreach($categoryData as $cat)
                                    <li class="active"><a
                                                href="{{route('product-by-category').'/'.$cat->category_name}}">{{$cat->category_name}}</a>
                                    </li>
                                @endforeach
                            </ul>
                                                ...
                                                <figure>
                                                    ...
                                                    <a class="aa-product-img"
                                                       href="{{route('product-details').'/'.$product->slug}}">
                                                        <img src="{{url('lib/uploads/images/product/'.$product->image)}}"
                                                             alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn" href=""><span
                                                                class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                                        <h4 class="aa-product-title"><a href="#">{{$product->name}}</a>
                                                        </h4>
